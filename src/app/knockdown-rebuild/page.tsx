...
export default function KnockdownRebuildPage() {
  return (
    <MetriconThemePage
      ...
      description="Plan a knockdown rebuild or site redevelopment with feasibility checks, design matching, approvals, construction staging, and handover support."
      ...
      promoCards={[
        ...
        },
        {
          ...
          description: 'Assess acquisition cost, demolition, approvals, construction, holding costs, and exit value together.',
      ...
      storyBody={[
        ...
        'Modern-Property connects these checks to design and construction planning so the project moves forward with fewer surprises.',
      ]}
      ...
      proofPoints={[
        ...
        { title: 'Approval pathway', description: 'Council, developer, engineering, and building approvals are mapped before construction.', icon: ShieldCheck },
      ]}
